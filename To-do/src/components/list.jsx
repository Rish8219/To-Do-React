...
const List = ({ list, item, handleDelete, index, handleEdit, handleUpdate, isClicked }) => {
    ...
    return (
        ...
        <div className='flex'>
            <p type="text" style={{ textDecoration: show ? "none" : "line-through", backgroundColor: show ? "white" : "black", transition: "all 2s", color: show ? "black" : "white" }} className=" px-3 p-0.5 mt-8 ml-9 text-2xl w-11/16 h-10 shadow-black shadow-2xl text-black rounded-2xl border-none outline-none">{item}</p>
